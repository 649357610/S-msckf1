...
if("TRUE" STREQUAL "TRUE")
  set(msckf_vio_SOURCE_PREFIX /home/gaofan/s-msckf/src/msckf_vio)
  set(msckf_vio_DEVEL_PREFIX /home/gaofan/s-msckf/src/msckf_vio/cmake-build-debug/devel)
  ...
  set(msckf_vio_INSTALL_PREFIX /usr/local)
...
if(NOT "/home/gaofan/s-msckf/src/msckf_vio/cmake-build-debug/devel/include;/home/gaofan/s-msckf/src/msckf_vio/include;/usr/include;/usr/include/eigen3;/opt/ros/kinetic/include/opencv-3.3.1-dev;/opt/ros/kinetic/include/opencv-3.3.1-dev/opencv;/usr/include/suitesparse " STREQUAL " ")
  set(msckf_vio_INCLUDE_DIRS "")
  set(_include_dirs "/home/gaofan/s-msckf/src/msckf_vio/cmake-build-debug/devel/include;/home/gaofan/s-msckf/src/msckf_vio/include;/usr/include;/usr/include/eigen3;/opt/ros/kinetic/include/opencv-3.3.1-dev;/opt/ros/kinetic/include/opencv-3.3.1-dev/opencv;/usr/include/suitesparse")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'msckf_vio' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/gaofan/s-msckf/src/msckf_vio/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT msckf_vio_NUM_DUMMY_TARGETS)
      set(msckf_vio_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::msckf_vio::wrapped-linker-option${msckf_vio_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR msckf_vio_NUM_DUMMY_TARGETS "${msckf_vio_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::msckf_vio::wrapped-linker-option${msckf_vio_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND msckf_vio_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/gaofan/s-msckf/src/msckf_vio/cmake-build-debug/devel/lib;/home/gaofan/gyj_ros/devel/lib;/home/gaofan/SVO/devel/lib;/opt/ros/kinetic/lib)
